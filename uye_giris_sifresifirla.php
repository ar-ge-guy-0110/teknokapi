                ...
                <table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td width="500" valign="top">
                            <form action="index.php?SO=38&AktivasyonKodu=<?php echo $_REQUEST["AktivasyonKodu"]; ?>&EPosta=<?php echo $_REQUEST["EPosta"]; ?>" method="post">
                                <table width="500" align="center" border="0" cellpadding="0" cellspacing="0">
                                    <tr height="40">
                                        <td colspan="2"><h3>Şifre Sıfırlama</h3></td>
                                    </tr>
                                    <tr height="30">
                                        <td valign="top" style="border-bottom: 1px dashed #3cccb9;" colspan="2">Aşağıdan Hesabına Giriş Şifreni Değiştirebilirsin.</td>
                                    </tr>
                                    <tr height="30">
                                        <td valign="bottom" align="left" colspan="2"> Yeni Şifre (*)</td>
                                    </tr>
                                    <tr height="30">
                                        <td valign="top" align="left" colspan="2"><input type="password" name="Sifre" class="beauslot"></td>
                                    </tr>
                                    <tr height="30">
                                        <td valign="bottom" align="left" colspan="2"> Yeni Şifre Tekrarı (*)</td>
                                    </tr>
                                    <tr height="30">
                                        <td valign="top" align="left" colspan="2"><input type="password" name="SifreTekrari" class="beauslot"></td>
                                    </tr>
                                    <tr height="40">
                                        <td align="center" colspan="2"><input type="submit" value="Şifremi Güncelle" class="beaubgreen"></td>
                                    </tr>
                                </table>
                            </form>
                        </td>
                        ...
                        <table width="545" align="center" border="0" cellpadding="0" cellspacing="0">
                                <tr height="40">
                                    <td colspan="2"><h3>Yeni Şifre Oluşturma</h3></td>
                                </tr>
                                <tr height="30">
                                    <td valign="top" style="border-bottom: 1px dashed #3cccb9;" colspan="2">Çalışma Ve İşleyiş Açıklaması</td>
                                </tr>
                                <tr>
                                    <td colspan="2">&nbsp;</td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="2">Kullanıcı, kendisine iletilen mail içerisindeki "Yeni Şifre Oluştur" metnine tıklayacak olur ise, site yeni şifre oluşturma sayfası açılır ve kullanıcıdan, yeni hesap şifresini oluşturması istenir.</td>
                                </tr>
                                <tr>
                                    <td colspan="2">&nbsp;</td>
                                </tr>
