...
<table width="760" align="center" border="0" cellpadding="0" cellspacing="0">
    <tr height="70">
        <td width="560" bgcolor="#338DFF" style="color: #171717;" align="left"><h3>&nbsp;SİLİNMİŞ ÜYELER</h3></td>
        <td width="200" bgcolor="#338DFF" align="right"><a href="index.php?SOAE=1&SOAI=42" style="color: #171717; text-decoration: none;">Aktif Üyeler</a>&nbsp;</td>
    </tr>
    <tr height="10">
                ...
                <tr>
                    <td colspan="9" align="right">
                        <table width="95" align="right" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td width="20">&nbsp;</td>
                                <td width="25" valign="center" align="left"><a href="index.php?SOAE=1&SOAI=45&id=<?php echo DonusumleriGeriDondur($uye["id"]) ?>"><img src="../resimler/button/updated.png"border="0"></a></td>
                                <td width="50" valign="center" align="left"><a href="index.php?SOAE=1&SOAI=45&id=<?php echo DonusumleriGeriDondur($uye["id"]) ?>" style="color: #338DFF; text-decoration: none;"><b>Aktif Et</b><a></td>
                            </tr>
                        </table>
                    </td>
                </tr>
